import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-e_x9MT2V.js';
import { B as Block, S as Static, f as BlockLabel, v as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, A as Undo, D as Download } from './2-DnDm89U_.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-DhAb1x-7.js';
export { default as BaseExample } from './Example17-BjeGoEZh.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CCUnbjWm.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-QL9nvpat.js');
  return module.default;
}
...
//# sourceMappingURL=Index52-UTPLAr6R.js.map
