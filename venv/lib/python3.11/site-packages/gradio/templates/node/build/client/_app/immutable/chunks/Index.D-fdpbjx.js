...
import { S as Static, k as Index$1 } from "./2.DuavqcSm.js";
function create_fragment$1(ctx) {
  let div2;
  let button;
  let textContent = `<div class="chevron svelte-av8s43"><span class="chevron-left svelte-av8s43"></span></div>`;
  let t;
  let div1;
  let current;
  let mounted;
  ...
  return {
    ...
    h() {
      attr(button, "class", "toggle-button svelte-av8s43");
      attr(button, "aria-label", "Toggle Sidebar");
      attr(div1, "class", "sidebar-content svelte-av8s43");
      attr(div2, "class", "sidebar svelte-av8s43");
      set_style(
        div2,
        "width",
        /*width_css*/
