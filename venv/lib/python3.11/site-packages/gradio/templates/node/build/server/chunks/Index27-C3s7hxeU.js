import { c as create_ssr_component, v as validate_component, b as add_attribute, e as escape } from './ssr-e_x9MT2V.js';
import { B as Block, S as Static, K as BlockTitle } from './2-DnDm89U_.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} <div class="wrap svelte-10lj3xl"><div class="head svelte-10lj3xl"><label${add_attribute("for", id, 0)}>${validate_component(BlockTitle, "BlockTitle").$$render($$result, { root, show_label, info }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
        })}</label> <div class="tab-like-container svelte-10lj3xl"><input${add_attribute("aria-label", `number input for ${label}`, 0)} data-testid="number-input" type="number"${add_attribute("min", minimum, 0)}${add_attribute("max", maximum, 0)}${add_attribute("step", step, 0)} ${disabled ? "disabled" : ""} class="svelte-10lj3xl"${add_attribute("value", value, 0)}${add_attribute("this", number_input, 0)}> ${show_reset_button ? `<button class="reset-button svelte-10lj3xl" ${disabled ? "disabled" : ""} aria-label="Reset to default value" data-testid="reset-button">↺</button>` : ``}</div></div> <div class="slider_input_container svelte-10lj3xl"><span class="min_value svelte-10lj3xl">${escape(minimum_value)}</span> <input type="range"${add_attribute("id", id, 0)} name="cowbell"${add_attribute("min", minimum, 0)}${add_attribute("max", maximum, 0)}${add_attribute("step", step, 0)} ${disabled ? "disabled" : ""}${add_attribute("aria-label", `range slider for ${label}`, 0)} class="svelte-10lj3xl"${add_attribute("value", value, 0)}${add_attribute("this", range_input, 0)}> <span class="max_value svelte-10lj3xl">${escape(maximum)}</span></div></div>`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index27-C3s7hxeU.js.map
