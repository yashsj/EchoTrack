import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-e_x9MT2V.js';
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-DnDm89U_.js';
import { D as DownloadLink } from './DownloadLink-BKoLBgET.js';
import Example from './Example6-Bwcofhh6.js';
...
const lang_map = {
  python: () => import('./index28-BUlcoeHi.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-B54j32fA.js'),
      import('./frontmatter-D7KxZtyE.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-DRBv98X5.js').then((m) => m.json()),
  html: () => import('./index30-DJycUt4V.js').then((m) => m.html()),
  css: () => import('./index31-bP0oPzhH.js').then((m) => m.css()),
  javascript: () => import('./index32-C93vKhqf.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-C93vKhqf.js').then(
...
//# sourceMappingURL=Index13-DK375mVs.js.map
