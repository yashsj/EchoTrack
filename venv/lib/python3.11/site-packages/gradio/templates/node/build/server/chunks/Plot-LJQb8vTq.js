import { c as create_ssr_component, a as createEventDispatcher, v as validate_component, m as missing_component } from './ssr-e_x9MT2V.js';
import { h as Empty, aB as Plot$1 } from './2-DnDm89U_.js';
...
const Plot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const plotTypeMapping = {
    plotly: () => import('./PlotlyPlot-DimIvh8S.js'),
    bokeh: () => import('./BokehPlot-CpsLHZOa.js'),
    altair: () => import('./AltairPlot-DmQPkmZ0.js'),
    matplotlib: () => import('./MatplotlibPlot-CPhme4lH.js')
  };
...
//# sourceMappingURL=Plot-LJQb8vTq.js.map
