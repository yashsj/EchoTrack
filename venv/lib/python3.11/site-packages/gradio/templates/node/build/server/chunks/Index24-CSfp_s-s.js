import { B as Block, S as Static, K as BlockTitle, h as Empty, av as LineChart, aa as globals } from './2-DnDm89U_.js';
import { c as create_ssr_component, v as validate_component, e as escape, b as add_attribute } from './ssr-e_x9MT2V.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-Brd6RPeV.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index24-CSfp_s-s.js.map
