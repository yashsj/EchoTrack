import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, f as each, n as null_to_empty, o as onDestroy } from './ssr-e_x9MT2V.js';
import { t as tick } from './Component-DtWdek5W.js';
import { B as Block, S as Static, t as MarkdownCode, w as Copy, O as Minimize, P as Maximize } from './2-DnDm89U_.js';
import { d as dequal } from './index6-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-DhAb1x-7.js';
export { default as BaseExample } from './Example8-smmO59oE.js';
...
const css$5 = {
  code: "input.svelte-svrul5{position:absolute;top:var(--size-2);right:var(--size-2);bottom:var(--size-2);left:var(--size-2);flex:1 1 0%;transform:translateX(-0.1px);outline:none;border:none;background:transparent;cursor:text}span.svelte-svrul5{flex:1 1 0%;position:relative;display:inline-block;outline:none;padding:var(--size-2);padding-right:0;-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;cursor:text;width:100%;height:100%}span.expanded.svelte-svrul5{height:auto;min-height:100%;white-space:pre-wrap;word-break:break-word;white-space:normal}.multiline.svelte-svrul5{white-space:pre-line}.header.svelte-svrul5{transform:translateX(0);font-weight:var(--weight-bold);white-space:normal;word-break:break-word}.edit.svelte-svrul5{opacity:0;pointer-events:none}",
  map: '{"version":3,"file":"EditableCell.svelte","sources":["EditableCell.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { createEventDispatcher } from \\"svelte\\";\\nimport { MarkdownCode } from \\"@gradio/markdown-code\\";\\nexport let edit;\\nexport let value = \\"\\";\\nexport let display_value = null;\\nexport let styling = \\"\\";\\nexport let header = false;\\nexport let datatype = \\"str\\";\\nexport let latex_delimiters;\\nexport let clear_on_focus = false;\\nexport let line_breaks = true;\\nexport let editable = true;\\nexport let root;\\nexport let max_chars = null;\\nconst dispatch = createEventDispatcher();\\nlet is_expanded = false;\\nexport let el;\\n$: _value = value;\\nfunction truncate_text(text, max_length = null) {\\n    const str = String(text);\\n    if (!max_length || str.length <= max_length)\\n        return str;\\n    return str.slice(0, max_length) + \\"...\\";\\n}\\n$: display_text = is_expanded ? value : truncate_text(display_value || value, max_chars);\\nfunction use_focus(node) {\\n    if (clear_on_focus) {\\n        _value = \\"\\";\\n    }\\n    requestAnimationFrame(() => {\\n        node.focus();\\n    });\\n    return {};\\n}\\nfunction handle_blur({ currentTarget }) {\\n    value = currentTarget.value;\\n    dispatch(\\"blur\\");\\n}\\nfunction handle_keydown(event) {\\n    if (event.key === \\"Enter\\") {\\n        if (edit) {\\n            value = _value;\\n            dispatch(\\"blur\\");\\n        }\\n        else if (!header) {\\n            is_expanded = !is_expanded;\\n        }\\n    }\\n    dispatch(\\"keydown\\", event);\\n}\\nfunction handle_click() {\\n    if (!edit && !header) {\\n        is_expanded = !is_expanded;\\n    }\\n}\\n<\/script>\\n\\n{#if edit}\\n\\t<input\\n\\t\\trole=\\"textbox\\"\\n\\t\\tbind:this={el}\\n\\t\\tbind:value={_value}\\n\\t\\tclass:header\\n\\t\\ttabindex=\\"-1\\"\\n\\t\\ton:blur={handle_blur}\\n\\t\\ton:mousedown|stopPropagation\\n\\t\\ton:mouseup|stopPropagation\\n\\t\\ton:click|stopPropagation\\n\\t\\tuse:use_focus\\n\\t\\ton:keydown={handle_keydown}\\n\\t/>\\n{/if}\\n\\n<span\\n\\ton:click={handle_click}\\n\\ton:keydown={handle_keydown}\\n\\ttabindex=\\"0\\"\\n\\trole=\\"button\\"\\n\\tclass:edit\\n\\tclass:expanded={is_expanded}\\n\\tclass:multiline={header}\\n\\ton:focus|preventDefault\\n\\tstyle={styling}\\n\\tclass=\\"table-cell-text\\"\\n\\tdata-editable={editable}\\n\\tplaceholder=\\" \\"\\n>\\n\\t{#if datatype === \\"html\\"}\\n\\t\\t{@html display_text}\\n\\t{:else if datatype === \\"markdown\\"}\\n\\t\\t<MarkdownCode\\n\\t\\t\\tmessage={display_text.toLocaleString()}\\n\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t{line_breaks}\\n\\t\\t\\tchatbot={false}\\n\\t\\t\\t{root}\\n\\t\\t/>\\n\\t{:else}\\n\\t\\t{editable ? display_text : display_value || display_text}\\n\\t{/if}\\n</span>\\n\\n<style>\\n\\tinput {\\n\\t\\tposition: absolute;\\n\\t\\ttop: var(--size-2);\\n\\t\\tright: var(--size-2);\\n\\t\\tbottom: var(--size-2);\\n\\t\\tleft: var(--size-2);\\n\\t\\tflex: 1 1 0%;\\n\\t\\ttransform: translateX(-0.1px);\\n\\t\\toutline: none;\\n\\t\\tborder: none;\\n\\t\\tbackground: transparent;\\n\\t\\tcursor: text;\\n\\t}\\n\\n\\tspan {\\n\\t\\tflex: 1 1 0%;\\n\\t\\tposition: relative;\\n\\t\\tdisplay: inline-block;\\n\\t\\toutline: none;\\n\\t\\tpadding: var(--size-2);\\n\\t\\tpadding-right: 0;\\n\\t\\t-webkit-user-select: text;\\n\\t\\t-moz-user-select: text;\\n\\t\\t-ms-user-select: text;\\n\\t\\tuser-select: text;\\n\\t\\tcursor: text;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t}\\n\\n\\tspan.expanded {\\n\\t\\theight: auto;\\n\\t\\tmin-height: 100%;\\n\\t\\twhite-space: pre-wrap;\\n\\t\\tword-break: break-word;\\n\\t\\twhite-space: normal;\\n\\t}\\n\\n\\t.multiline {\\n\\t\\twhite-space: pre-line;\\n\\t}\\n\\n\\t.header {\\n\\t\\ttransform: translateX(0);\\n\\t\\tfont-weight: var(--weight-bold);\\n\\t\\twhite-space: normal;\\n\\t\\tword-break: break-word;\\n\\t}\\n\\n\\t.edit {\\n\\t\\topacity: 0;\\n\\t\\tpointer-events: none;\\n\\t}</style>\\n"],"names":[],"mappings":"AAuGC,mBAAM,CACL,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,QAAQ,CAAC,CAClB,KAAK,CAAE,IAAI,QAAQ,CAAC,CACpB,MAAM,CAAE,IAAI,QAAQ,CAAC,CACrB,IAAI,CAAE,IAAI,QAAQ,CAAC,CACnB,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,EAAE,CACZ,SAAS,CAAE,WAAW,MAAM,CAAC,CAC7B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,WAAW,CACvB,MAAM,CAAE,IACT,CAEA,kBAAK,CACJ,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,EAAE,CACZ,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,CACrB,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,QAAQ,CAAC,CACtB,aAAa,CAAE,CAAC,CAChB,mBAAmB,CAAE,IAAI,CACzB,gBAAgB,CAAE,IAAI,CACtB,eAAe,CAAE,IAAI,CACrB,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CAEA,IAAI,uBAAU,CACb,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,IAAI,CAChB,WAAW,CAAE,QAAQ,CACrB,UAAU,CAAE,UAAU,CACtB,WAAW,CAAE,MACd,CAEA,wBAAW,CACV,WAAW,CAAE,QACd,CAEA,qBAAQ,CACP,SAAS,CAAE,WAAW,CAAC,CAAC,CACxB,WAAW,CAAE,IAAI,aAAa,CAAC,CAC/B,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,UACb,CAEA,mBAAM,CACL,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IACjB"}'
};
function truncate_text(text, max_length = null) {
  const str = String(text);
  if (!max_length || str.length <= max_length)
...
const EditableCell = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${edit ? `<input role="textbox" tabindex="-1" class="${["svelte-svrul5", header ? "header" : ""].join(" ").trim()}"${add_attribute("this", el, 0)}${add_attribute("value", _value, 0)}>` : ``} <span tabindex="0" role="button"${add_attribute("style", styling, 0)} class="${[
    "table-cell-text svelte-svrul5",
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="table-container svelte-m6pdii"><div class="header-row svelte-m6pdii">${label && label.length !== 0 && show_label ? `<div class="label svelte-m6pdii"><p class="svelte-m6pdii">${escape(label)}</p></div>` : ``} ${validate_component(Toolbar, "Toolbar").$$render(
      $$result,
      {
        show_fullscreen_button,
        is_fullscreen,
      ...
      "table-wrap svelte-m6pdii",
      (dragging ? "dragging" : "") + " " + (!wrap ? "no-wrap" : "") + " " + ("")
    ].join(" ").trim()}" style="${"height:" + escape(table_height, true) + "px;"}" role="grid" tabindex="0"${add_attribute("this", parent, 0)}>${selected !== false && selected_cells.length === 1 ? `<button class="selection-button selection-button-column svelte-m6pdii" aria-label="Select column" data-svelte-h="svelte-1sqo8ds">⋮</button> <button class="selection-button selection-button-row svelte-m6pdii" aria-label="Select row" data-svelte-h="svelte-mm502l">⋮</button>` : ``} <table class="${["svelte-m6pdii", column_widths.length != 0 ? "fixed-layout" : ""].join(" ").trim()}"${add_attribute("this", table, 0)}>${label && label.length !== 0 ? `<caption class="sr-only">${escape(label)}</caption>` : ``} <thead class="svelte-m6pdii"><tr class="svelte-m6pdii">${show_row_numbers ? `<th class="row-number-header frozen-column always-frozen svelte-m6pdii" style="left: 0;" data-svelte-h="svelte-16yee2u"><div class="cell-wrap svelte-m6pdii"><div class="header-content svelte-m6pdii"><div class="header-text"></div></div></div></th>` : ``} ${each(_headers, ({ value, id }, i) => {
      return `<th${add_attribute("aria-sort", get_sort_status(), 0)} style="${"width: " + escape(column_widths.length ? column_widths[i] : void 0, true) + "; left: " + escape(
        ...
        "svelte-m6pdii",
        (i < actual_pinned_columns ? "frozen-column" : "") + " " + ((show_row_numbers ? i === actual_pinned_columns - 1 : i === actual_pinned_columns - 1) ? "last-frozen" : "") + " " + (header_edit === i ? "editing" : "")
      ].join(" ").trim()}"><div class="cell-wrap svelte-m6pdii"><div class="header-content svelte-m6pdii">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
        ...
        {},
        {}
      )} <div class="sort-buttons svelte-m6pdii">${validate_component(SortIcon, "SortIcon").$$render(
        $$result,
        {
          direction: sort_by === i ? sort_direction : null,
          i18n
    ...
    })}</tr></thead> <tbody><tr class="svelte-m6pdii">${each(max, ({ value, id }, j) => {
      return `<td tabindex="-1" class="svelte-m6pdii"${add_attribute("this", cells[j], 0)}><div class="cell-wrap svelte-m6pdii">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
      ...
      },
      {
        default: () => {
          return `${validate_component(VirtualTable, "VirtualTable").$$render(
            ...
            {
              tbody: ({ index, item }) => {
                return `<tr slot="tbody" class="${["svelte-m6pdii", index % 2 === 0 ? "row_odd" : ""].join(" ").trim()}">${show_row_numbers ? `<td class="row-number frozen-column always-frozen svelte-m6pdii" style="left: 0;" tabindex="-1">${escape(index + 1)}</td>` : ``} ${each(item, ({ value, id }, j) => {
                  return `<td${add_attribute("tabindex", show_row_numbers && j === 0 ? -1 : 0, 0)} style="${"width: " + escape(get_cell_width(j), true) + "; left: " + escape(
                    ...
                    escape(null_to_empty(is_cell_selected([index, j], selected_cells)), true) + " svelte-m6pdii",
                  ...
                  ].join(" ").trim()}"${add_attribute("this", els[id].cell, 0)}><div class="cell-wrap svelte-m6pdii">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      display_value: display_value?.[index]?.[j],
                      latex_delimiters,
                    ...
                    {}
                  )} ${editable && should_show_cell_menu([index, j], selected_cells, editable) ? `<button class="cell-menu-button svelte-m6pdii" data-svelte-h="svelte-15lbpst">⋮
									</button>` : ``}</div> </td>`;
                })}</tr>`;
              },
              thead: () => {
                return `<tr slot="thead" class="svelte-m6pdii">${show_row_numbers ? `<th class="row-number-header frozen-column always-frozen svelte-m6pdii" style="left: 0;" data-svelte-h="svelte-16yee2u"><div class="cell-wrap svelte-m6pdii"><div class="header-content svelte-m6pdii"><div class="header-text"></div></div></div></th>` : ``} ${each(_headers, ({ value, id }, i) => {
                  return `<th${add_attribute("aria-sort", get_sort_status(), 0)} style="${"width: " + escape(get_cell_width(i), true) + "; left: " + escape(
                    ...
                    {},
                    {}
                  )} </div></div> ${editable ? `<button class="cell-menu-button svelte-m6pdii" data-svelte-h="svelte-3v1qhb">⋮
									</button>` : ``}</div> </th>`;
                })}</tr>`;
              },
              default: () => {
...
//# sourceMappingURL=Index56-xt4otVM4.js.map
